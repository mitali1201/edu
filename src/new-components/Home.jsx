    ...
    const handleOnCLick2 = async () => {
      ...
      const handleOnCLick3 = async () => {
        ...
        const handleOnCLick4 = async () => {
          ...
          const handleOnCLick5 = async () => {
            navi('/Sub5');
          }
            const handleOnCLick6 = async () => {
              navi('/Sub6');
            }
              const handleOnCLick7 = async () => {
                navi('/Sub7');
              }
                const handleOnCLick8 = async () => {
                  navi('/Sub8');
                }
        ...
        <div className="card">
            ...
            <div className="flip-card__container">
              <div className="card-front">
                <div className="card-front__tp card-front__tp--city">
                  ...
                  {/* </svg> */}
                  <h2 style={{fontSize:"20px", marginBottom:"10px"}} className="card-front__heading">I </h2>
                  <p style={{fontSize:"20px", marginBottom:"15px"}} className="card-front__text-price">Year</p>
                </div>
              ...
              <div className="card-back">
                  ...
                  {/* <source
                    ...
                    type="video/mp4"
                  /> */}
                  <img src='https://leverageedublog.s3.ap-south-1.amazonaws.com/blog/wp-content/uploads/2020/09/04184424/How-to-Become-a-Software-Engineer.jpg' height="150px" width="150px"/>
          ...
          <div className="inside-page">
            <div className="inside-page__container">
              ...
              <a href="#" onClick={() => handleOnCLick()} className="inside-page__btn inside-page__btn--city">
                I semester
              </a>
              <a href="#" onClick={() => handleOnCLick2()}  className="inside-page__btn inside-page__btn--city">
                II semester
              </a>
            </div>
          </div>
        ...
        <div className="card">
            ...
            <div className="flip-card__container">
              <div className="card-front">
                <div className="card-front__tp card-front__tp--ski">
                  ...
                  <h2 style={{fontSize:"20px", marginBottom:"10px"}} className="card-front__heading">II </h2>
                  <p style={{fontSize:"20px", marginBottom:"15px"}} className="card-front__text-price">Year</p>
                </div>
                <div className="card-front__bt">
              ...
              <div className="card-back">
                {/* <video className="video__container" autoPlay="" muted="" loop=""> */}
                  {/* <source
                    className="video__media"
                    src="https://images1.content-hci.com/commimg/myhotcourses/blog/post/myhc_89683.jpg"
                    type="video/mp4"
                  /> */}
                  <img src='https://images1.content-hci.com/commimg/myhotcourses/blog/post/myhc_89683.jpg' height="150px" width="150px" />
                {/* </video> */}
              </div>
            </div>
          </div>
          <div className="inside-page">
            <div className="inside-page__container">
              ...
              <a href="#" onClick={() => handleOnCLick3()} className="inside-page__btn inside-page__btn--ski">
                III Semester
              </a>
              <a href="#" onClick={() => handleOnCLick4()} className="inside-page__btn inside-page__btn--ski">
              IV Semester
              </a>
            </div>
          </div>
            ...
            <div className="flip-card__container">
              <div className="card-front">
                <div className="card-front__tp card-front__tp--beach">
                  ...
                  <h2 style={{fontSize:"20px", marginBottom:"10px"}} className="card-front__heading">III </h2>
                  <p style={{fontSize:"20px", marginBottom:"15px"}} className="card-front__text-price">Year</p>
                </div>
                <div className="card-front__bt">
              ...
              <div className="card-back">
                ...
                <img src='https://blog-digital.aakash.ac.in/wp-content/uploads/2019/07/CSE.jpg' height="150px" width="150px" />
              </div>
            </div>
          </div>
          <div className="inside-page">
            <div className="inside-page__container">
              ...
              <a href="#" onClick={() => handleOnCLick5()} className="inside-page__btn inside-page__btn--beach">
                V Semester
              </a>
              <a href="#" onClick={() => handleOnCLick6()} className="inside-page__btn inside-page__btn--beach">
                VI Semester
              </a>
            </div>
          </div>
        ...
        <div className="card">
            ...
            <div className="flip-card__container">
              <div className="card-front">
                <div className="card-front__tp card-front__tp--camping">
                  ...
                  <h2 style={{fontSize:"20px", marginBottom:"10px"}} className="card-front__heading">IV </h2>
                  <p style={{fontSize:"20px", marginBottom:"15px"}} className="card-front__text-price">Year</p>
                </div>
                <div className="card-front__bt">
              ...
              <div className="card-back">
               ...
               <img src="https://www.analyticsinsight.net/wp-content/uploads/2021/11/Quantum-computer-engineer.jpg" height="150px" width="150px" />
          ...
          <div className="inside-page">
            <div className="inside-page__container">
              ...
              <a href="#" onClick={() => handleOnCLick7()} className="inside-page__btn inside-page__btn--camping">
                VII Semester
              </a>
              <a href="#" onClick={() => handleOnCLick8()} className="inside-page__btn inside-page__btn--camping">
                VIII Semester
              </a>
            </div>
          </div>
