  ...
  <div id="pagewrap">
    <div  className="gallery">
      ...
      <ul>
          ...
          <br />
          <br />
          <h4 style={{fontFamily:"cursive"}}>Course Code - CY 19.101</h4>
         <h4 style={{fontFamily:"cursive", marginRight:"110px"}}> Credits - 3 </h4>
             <h4 style={{fontFamily:"cursive", marginRight:"110px"}}>Modules - 5
          </h4>
        </ul>
      ...
      <ul>
          ...
          <br />
          <br />
          <h4 style={{fontFamily:"cursive"}}>Course Code - MA 19.102</h4>
         <h4 style={{fontFamily:"cursive", marginRight:"110px"}}> Credits - 3 </h4>
             <h4 style={{fontFamily:"cursive", marginRight:"110px"}}>Modules - 5
          </h4>
        </ul>
      ...
      <ul>
          <h1>Basics of Electronics Engineering</h1>
          <br />
          <br />
          <br />
          <br />
          <br />
          <h4 style={{fontFamily:"cursive"}}>Course Code - EC 19.101</h4>
         <h4 style={{fontFamily:"cursive", marginRight:"110px"}}> Credits - 3 </h4>
             <h4 style={{fontFamily:"cursive", marginRight:"110px"}}>Modules - 5
          </h4>
        </ul>
